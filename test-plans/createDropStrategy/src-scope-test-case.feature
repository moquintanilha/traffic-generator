...
Scenario: Create a new rule to successfully drop 50% traffic by source scope
    ...
    And the name of the application originating the request is present in the X-SOURCE-SCOPE header
